...
11. \*Save the token from the previous step as the `GITHUB_API_ACCESS_TOKEN` environment variable at the service that is hosting your organization’s instance of *sign-and-verify*
